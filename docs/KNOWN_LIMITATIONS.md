...
| 6 | Potential **near-duplicate / leaked emails** across the train/test split could inflate in-distribution scores. | TBD | To be checked in EDA (duplicate analysis); will be reported if material. |
